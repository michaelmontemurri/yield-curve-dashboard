import { CONFIG, MATURITY_DEFS, dom, state } from "./core.js?v=maturity-change-table-20260611-2";
import {
  average,
  clampNumber,
  dotProduct,
...
import { isDateInRanges, resolveRegimePreset } from "./regimes.js?v=maturity-change-table-20260611-2";
